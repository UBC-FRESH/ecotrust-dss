...
def render_content(tab):
    ...
    # print(T_df_plot_12)
    print('___________________ output_1')
    print(T_cbm_output_1)
    print('___________________output_2')
    print(T_cbm_output_2)
    print('___________________ output_3')
    ...
    print('___________________ output_4')
    ...
    if tab == 'scn-1-graph':
        return html.Div([
            ...
            html.H3('Business as usual scenario'),
    ...
    if(numOfPointsInPoly > 2):
       ...
       # sjoin_results = gpd.sjoin(abridgedStands, gdf, how='left', predicate='within')
        ...
        for scenario_name in scenario_names:
            ...
            df_plot_12, cbm_output_1, cbm_output_2, forest_type_alt, df_plot_34, cbm_output_3, cbm_output_4, forest_type_base = results_scenarios(fm, 
                      clt_percentage, 
                      credibility, 
                      budget_input, 
                      n_steps, 
